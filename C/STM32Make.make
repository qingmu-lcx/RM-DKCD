...
GCC_PATH="C:/USERS/MI/.EIDE/TOOLS/GCC_ARM/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/MI/.EIDE/TOOLS/OPENOCD_7A1ADFBEC_MINGW32/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/MI/.EIDE/TOOLS/OPENOCD_7A1ADFBEC_MINGW32/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f4x mass_erase 0; exit"
